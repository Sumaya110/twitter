...
export const getNewUser = (payload) => API.get('/api/users',  {params:{email:payload, purpose:"get-a-user"}});
export const getNewUsers = () => API.get('/api/users', { params: { purpose: "get-all-users" } });
